        ...
        <button
          className={cx(
            ...
            FOCUS_VISIBLE_OUTLINE,
            {
              ...
              "hover:shadow-cyan-500/50": currentUserLikes !== 0,
            },
          )}
          onClick={handleClick}
        >
          <div
            className={cx(
              "absolute inset-0 transform-gpu bg-gradient-to-tl from-cyan-500 to-neutral-400 transition-transform",
              {
          ...
          <HeartFilledIcon className="relative w-5 transform text-neutral-100 transition delay-100 duration-500 ease-out group-hover:scale-110" />
        </button>
      </div>

      {/* Like counter text */}
      <div className="text-lg font-medium leading-none text-neutral-100/90">
