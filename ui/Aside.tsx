    ...
    >
      <div
        className={clsx("relative xl:absolute xl:top-0 xl:left-0 xl:right-0", {
          "z-10 border-l-2 border-neutral-200/5 bg-neutral-900 pl-4 xl:border-t-2 xl:border-l-0 xl:py-6 xl:pl-0":
            styled,
        })}
      >
        {title ? (
        ...
        <div
          className={clsx({
            "text-sm italic text-neutral-100/60 [&>span[data-rehype-pretty-code-fragment]]:!text-[11px]":
              styled,
          })}
        >
          {children}
