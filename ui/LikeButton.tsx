    ...
    <div className="flex items-center space-x-2">
      ...
      >
        <div className="relative">
          ...
          >
            <motion.div
              className="inset absolute h-full w-full bg-gradient-to-tl from-cyan-500 to-neutral-400"
            ...
            <HeartFilledIcon className="relative w-5 text-neutral-100" />
          </motion.div>
        </div>
      </button>

      {/* Like counter text */}
      <div className="text-lg text-neutral-100/90">
